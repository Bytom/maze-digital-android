...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        Log.i("xiaok","inputUri:"+inputUri);
        Log.i("xiaok","outputUri:"+outputUri);
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setCropFrameColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_FRAME_COLOR, getResources().getColor(R.color.ucrop_color_yellow)));
        ...
        mOverlayView.setCropGridColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_COLOR, getResources().getColor(R.color.ucrop_color_green)));
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mLogoColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_LOGO_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_green));
    ...
    protected void cropAndSaveImage() {
        ...
        mGestureCropImageView.cropAndSaveImage(mCompressFormat, mCompressQuality, new BitmapCropCallback() {
            ...
            @Override
            public void onBitmapCroppedFinish(@NonNull Bitmap cropBitmap) {
