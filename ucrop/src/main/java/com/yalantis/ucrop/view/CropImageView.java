...
import com.yalantis.ucrop.task.BitmapCropTaskNew;
...
public class CropImageView extends TransformImageView {
    ...
    public void cropAndSaveImageNew(@NonNull Context context,Bitmap.CompressFormat compressFormat, int compressQuality,
                                 @Nullable BitmapCropCallback cropCallback) {
        cancelAllAnimations();
        setImageToWrapCropBounds(false);
        ...
        new BitmapCropTaskNew(context,getViewBitmap(), imageState, cropParameters, cropCallback)
                .executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
