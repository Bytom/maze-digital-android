 ...
 */
public class BitmapCropTaskNew extends AsyncTask<Void, Void, Throwable> {
...
//    private final ExifInfo mExifInfo;
    ...
    public BitmapCropTaskNew(@NonNull Context context, @Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
    ...
    private boolean crop() throws IOException {
        ...
        if (shouldCrop) {
            checkValidityCropBounds();
             mCropBitmap = Bitmap.createBitmap(mViewBitmap, cropOffsetX, cropOffsetY, mCroppedImageWidth, mCroppedImageHeight);
...
//                mCropCallback.onBitmapCropped(uri, cropOffsetX, cropOffsetY, mCroppedImageWidth, mCroppedImageHeight);
                mCropCallback.onBitmapCroppedFinish(mCropBitmap);
            } else {
