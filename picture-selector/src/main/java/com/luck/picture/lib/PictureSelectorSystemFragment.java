...
public class PictureSelectorSystemFragment extends PictureCommonFragment {
    ...
    private void createMultipleDocuments() {
        mDocMultipleLauncher = requireActivity().registerForActivityResult(new ActivityResultContract<String, List<Uri>>() {
    ...
    private void createSingleDocuments() {
        mDocSingleLauncher = requireActivity().registerForActivityResult(new ActivityResultContract<String, Uri>() {
    ...
    private void createMultipleContents() {
        mContentsLauncher = requireActivity().registerForActivityResult(new ActivityResultContract<String, List<Uri>>() {
    ...
    private void createContent() {
        mContentLauncher = requireActivity().registerForActivityResult(new ActivityResultContract<String, Uri>() {
